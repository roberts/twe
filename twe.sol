 ...
 *
   ...
   Twenty-Eight Coin
   https://TWECoin.org
   https://t.me/TwentyEightCoin
   https://x.com/TWECoinERC
   

   Contract features:
   28,000,000,000 tokens
   2.8% buy tax in ETH sent to marketing, community & dev
   2.8% sell tax in ETH sent to marketing, community & dev
 */
...
contract twe is ERC20, Ownable {
    ...
    constructor() ERC20("Twenty-Eight Coin", "TWE") {
        uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        _approve(address(this), address(uniswapV2Router), type(uint256).max);
 
        uint256 totalSupply = 28_000_000_000 ether;
 
        maxTransactionAmount = (totalSupply) / 100; // 1% of total supply (280,000,000 tokens)
        maxWallet = (totalSupply) / 50;  // 2% of total supply (560,000,000 tokens)
        swapTokensAtAmount = (totalSupply * 5) / 10000;
 
        buyMarketingFee = 10; // 1% since divided by 1,000 instead of 100
        buyDevelopmentFee = 8; // 0.8% since divided by 1,000 instead of 100
        buyCommunityFundFee = 10; // 1% since divided by 1,000 instead of 100
        buyTotalFees =
            buyMarketingFee +
            buyDevelopmentFee +
            buyCommunityFundFee;
 
        sellMarketingFee = 10; // 1% since divided by 1,000 instead of 100
        sellDevelopmentFee = 8; // 0.8% since divided by 1,000 instead of 100
        sellCommunityFundFee = 10; // 1% since divided by 1,000 instead of 100
        sellTotalFees =
            sellMarketingFee +
            sellDevelopmentFee +
    ...
    function _transfer(
        ...
        if (takeFee) {
            // on sell - notice divide by 1,000 instead of 100
            ...
            // on buy - notice divide by 1,000 instead of 100
